...
import { MapPin, Award, UserCheck, Edit3, Check, Globe, RefreshCcw, Landmark } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        ...
        <form onSubmit={handleUpdate} className="md:col-span-7 bg-white border border-gray-200 rounded-xl p-6 sm:p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="h-56 bg-zinc-100 rounded border border-gray-300 overflow-hidden relative">
              {isMapKeyConfigured ? (
